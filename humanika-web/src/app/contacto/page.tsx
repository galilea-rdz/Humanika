  ...
  return (
    <>
      ...
      <main className="pt-20">
        <section className="bg-gradient-to-br from-[#0A3A7A] via-[#1173E4] to-[#0B4FC2] py-20">
        ...
        <section className="py-20 bg-[#FDFDFD]">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              {/* Contact info */}
              <div>
                <h2 className="font-sora text-2xl font-bold text-[#191616] mb-6">
                  Información de contacto
                </h2>
                <div className="flex flex-col gap-5">
                  <a href="tel:+528182074338" className="flex items-center gap-4 group">
                    <div className="w-12 h-12 bg-[#D6E8FF] rounded-full flex items-center justify-center group-hover:bg-[#1173E4] transition-colors">
                      <Phone className="w-5 h-5 text-[#1173E4] group-hover:text-white transition-colors" />
                    </div>
                    <div>
                      <p className="text-xs text-[#5A6478] mb-0.5">Teléfono</p>
                      <p className="font-medium text-[#191616]">+52 1 81 8207 4338</p>
                    </div>
                  </a>
                  <a href="https://wa.me/528182074338" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                    <div className="w-12 h-12 bg-[#D6E8FF] rounded-full flex items-center justify-center group-hover:bg-[#1173E4] transition-colors">
                      <MessageCircle className="w-5 h-5 text-[#1173E4] group-hover:text-white transition-colors" />
                    </div>
                    <div>
                      <p className="text-xs text-[#5A6478] mb-0.5">WhatsApp</p>
                      <p className="font-medium text-[#191616]">Escríbenos por WhatsApp</p>
                    </div>
                  </a>
                  <a href="https://www.linkedin.com/company/humanika" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                    <div className="w-12 h-12 bg-[#D6E8FF] rounded-full flex items-center justify-center group-hover:bg-[#1173E4] transition-colors">
                      <ExternalLink className="w-5 h-5 text-[#1173E4] group-hover:text-white transition-colors" />
                    </div>
                    <div>
                      <p className="text-xs text-[#5A6478] mb-0.5">LinkedIn</p>
                      <p className="font-medium text-[#191616]">linkedin.com/company/humanika</p>
                    </div>
                  </a>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-[#D6E8FF] rounded-full flex items-center justify-center">
                      <MapPin className="w-5 h-5 text-[#1173E4]" />
                    </div>
                    <div>
                      <p className="text-xs text-[#5A6478] mb-0.5">Ubicación</p>
                      <p className="font-medium text-[#191616]">Monterrey, N.L. · Servicio nacional</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-[8px] shadow-sm border border-gray-100 p-8">
                <h2 className="font-sora text-xl font-bold text-[#191616] mb-6">

        ...
        <section className="py-16 bg-white">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-8 text-[#5A6478]">
              <section>
                <h2 className="font-sora text-xl font-bold text-[#191616] mb-3">Titularidad del sitio</h2>
                <p>
                  El presente sitio web es propiedad y está operado por <strong>Humanika</strong>, con domicilio en Monterrey, Nuevo León, México. Para cualquier consulta, visita nuestra <a href="/contacto" className="text-[#1173E4] underline">página de contacto</a>.
                </p>
              </section>

              <section>
                <h2 className="font-sora text-xl font-bold text-[#191616] mb-3">Uso del sitio</h2>
                <p>
              ...
              <section>
                <h2 className="font-sora text-xl font-bold text-[#191616] mb-3">Propiedad intelectual</h2>
                <p>
              ...
              <section>
                <h2 className="font-sora text-xl font-bold text-[#191616] mb-3">Limitación de responsabilidad</h2>
                <p>
              ...
              <section>
                <h2 className="font-sora text-xl font-bold text-[#191616] mb-3">Legislación aplicable</h2>
                <p>

  ...
  return (
    <>
      ...
      <main className="pt-20">
        <section className="bg-gradient-to-br from-[#0A3A7A] to-[#1173E4] py-20">
        ...
        <section className="py-24 bg-[#FDFDFD]">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              <span className="inline-block px-4 py-2 bg-[#D6E8FF] text-[#1173E4] text-sm font-semibold rounded-full mb-6">
                Próximamente
              </span>
              <h2 className="font-sora text-2xl font-bold text-[#191616]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              {comingSoon.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm opacity-75">
                  <div className="w-10 h-10 bg-[#D6E8FF] rounded-lg flex items-center justify-center mb-4">

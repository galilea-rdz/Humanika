      ...
      <main className="pt-20">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              <div>
                <h2 className="font-sora text-2xl font-bold text-[#191616] mb-6">¿En qué situaciones intervenimos?</h2>
                <ul className="flex flex-col gap-3">
                  {scenarios.map(s => (
                    <li key={s} className="flex items-start gap-3">
                      <span className="w-2 h-2 rounded-full bg-[#1173E4] flex-shrink-0 mt-2" />
              ...
              <div className="space-y-6">
                <div className="p-6 bg-[#FDFDFD] rounded-xl border-l-4 border-[#1173E4]">
                  <h3 className="font-sora font-semibold text-[#191616] mb-3">Fase 1: Contención</h3>
                ...
                <div className="p-6 bg-[#FDFDFD] rounded-xl border-l-4 border-[#1173E4]">
                  <h3 className="font-sora font-semibold text-[#191616] mb-3">Fase 2: Evaluación y plan</h3>
                  <p className="text-sm text-[#5A6478]">Diagnóstico del impacto en el equipo y diseño de plan de intervención y recuperación.</p>
                </div>
                <div className="p-6 bg-[#FDFDFD] rounded-xl border-l-4 border-[#1173E4]">
                  <h3 className="font-sora font-semibold text-[#191616] mb-3">Fase 3: Seguimiento</h3>
        ...
        <section className="py-16 bg-[#FDFDFD]">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <div className="w-14 h-14 bg-[#D6E8FF] rounded-full flex items-center justify-center mx-auto mb-6">
              <Phone size={24} className="text-[#1173E4]" />
            </div>
            <h2 className="font-sora text-2xl font-bold text-[#191616] mb-4">¿Estás en una situación urgente?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+528182074338" className="inline-flex items-center justify-center px-7 py-4 border border-gray-200 text-[#191616] font-medium rounded-md hover:bg-white transition-colors">
                +52 81 8207 4338
              </a>
            </div>
          </div>

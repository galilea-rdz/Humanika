        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="mb-10 max-w-3xl">
              <h2 className="font-sora text-2xl font-bold text-[#0F1923] mb-4">No son talleres de wellness genéricos</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {programs.map((p) => (
                <div key={p.title} className="p-6 bg-[#F8F9FB] border-l-4 border-[#00C2A0] rounded-r-xl">
                  <h3 className="font-sora font-semibold text-[#0F1923] mb-3">{p.title}</h3>

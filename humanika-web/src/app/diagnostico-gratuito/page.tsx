    ...
    <div className="min-h-screen bg-[#F8F9FB]">
      ...
      <header className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a href="tel:+528182074338" className="flex items-center gap-2 text-sm text-[#5A6478] hover:text-[#1a5cb8] transition-colors">
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          {/* Left */}
          <div>
            <span className="inline-block px-3 py-1 bg-[#EBF2FF] text-[#1a5cb8] text-xs font-semibold rounded-full mb-6">
              Sin costo · Sin compromiso
            </span>
            <h1 className="font-sora text-4xl md:text-5xl font-bold text-[#0F1923] leading-tight mb-6">
            ...
            <h2 className="font-sora font-bold text-[#0F1923] mb-5">Lo que incluye:</h2>
            <ul className="flex flex-col gap-4 mb-10">
              {benefits.map((b) => (
                <li key={b} className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#00C2A0] mt-0.5 flex-shrink-0" />
                  <span className="text-[#0F1923]">{b}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="bg-white border border-gray-100 rounded-[8px] p-6">
              <p className="text-sm text-[#5A6478] leading-relaxed">
                <strong className="text-[#0F1923]">¿Por qué es gratuito?</strong> Creemos que el primer paso para transformar una organización es el diagnóstico. Queremos que conozcas la calidad de nuestro trabajo antes de tomar cualquier decisión.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[8px] shadow-sm border border-gray-100 p-8">
            <h2 className="font-sora text-xl font-bold text-[#0F1923] mb-2">
